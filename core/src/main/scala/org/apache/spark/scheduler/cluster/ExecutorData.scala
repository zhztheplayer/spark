 ...
 * @param executorResourceProfileId The id of the Executor ResourceProfile being used by
 *                                  this executor
 */
private[cluster] class ExecutorData(
    ...
    override val executorResourceProfileId: Int
) extends ExecutorInfo(executorHost, totalCores, logUrlMap, attributes,
  resourcesInfo, executorResourceProfileId)
